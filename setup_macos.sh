...
echo "rdr pass inet6 proto tcp from any to fd7f:1fa7:68ca:202f:4b5c:aef6::/96 port 1:65535 -> ::1 port 55555" | pfctl -a "com.apple/250.devprox" -Ef -
...
set State:/Network/Service/devprox-dummy-feth/IPv6
set Setup:/Network/Service/devprox-dummy-feth/IPv6
EOI
